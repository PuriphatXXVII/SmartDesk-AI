...
const en = {
  ...
  settings: {
    title: "Settings",
    subtitle: "Outbound webhooks — get notified when events happen in your workspace.",
    plan: "Plan",
    webhookUrl: "Webhook URL",
    webhookUrlPlaceholder: "https://your-app.com/webhooks/smartdesk",
    webhookSecret: "Signing secret (optional)",
    webhookSecretPlaceholder: "leave blank to keep current",
    secretSet: "A signing secret is set.",
    save: "Save settings",
    saved: "Saved",
    events: "Events we POST",
    hint: "Each delivery is signed with HMAC-SHA256 in the X-SmartDesk-Signature header.",
  },
  chat: {
    title: "Test your AI",
...
const th: Messages = {
  ...
  settings: {
    title: "ตั้งค่า",
    subtitle: "Webhook ขาออก — รับแจ้งเตือนเมื่อมีเหตุการณ์เกิดขึ้นใน workspace ของคุณ",
    plan: "แพ็กเกจ",
    webhookUrl: "Webhook URL",
    webhookUrlPlaceholder: "https://your-app.com/webhooks/smartdesk",
    webhookSecret: "Signing secret (ไม่บังคับ)",
    webhookSecretPlaceholder: "เว้นว่างเพื่อใช้ค่าเดิม",
    secretSet: "ตั้ง signing secret ไว้แล้ว",
    save: "บันทึกการตั้งค่า",
    saved: "บันทึกแล้ว",
    events: "เหตุการณ์ที่เราส่ง",
    hint: "ทุกการส่งจะถูกเซ็นด้วย HMAC-SHA256 ใน header X-SmartDesk-Signature",
  },
  chat: {
